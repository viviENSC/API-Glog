...
namespace EnfcGlog.Controllers
{
    public class EquipeController : Controller
    {
        ...
        public EquipeController(EnfcGlogContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,PouleId,nom,ecole,nbPoints")] Equipe equipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PouleId,nom,ecole,nbPoints")] Equipe equipe)
        {
            if (id != equipe.Id)
            {
                return NotFound();
